...
public class PagamentoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<obterPagamentoDto> detalhar(@PathVariable @NotNull Long id) {
        obterPagamentoDto dto = service.obterPorId(id);
